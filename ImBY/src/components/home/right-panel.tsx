...
const RightPanel = () => {
	...
	return (
		<div className='w-3/4 flex flex-col'>
				...
				{/* Header */}
				<div className='flex justify-between items-center bg-gray-primary p-3'>
				...
				{/* Centered ImBY Text */}
				<p className='absolute left-1/2 transform -translate-x-1/2 text-lg font-bold text-pink-600'>
					ImBY
				</p>
